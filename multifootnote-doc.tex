...
\begin{tip}
    By default, it doesn't quite matter where you put the \lstinline|\multifootnote|. However, if you have enabled the package option \packageoption{manual mode}, then the corresponding footnote text shall be added to the current page immediately at where you write \lstinline|\multifootnote|.
\end{tip}
